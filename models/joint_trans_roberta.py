...
class JointTransRobertaModel(NLUModel):
    ...
    def save(self, model_path):
        ...
        self.model.save(os.path.join(model_path, 'joint_roberta_model.h5'))
    ...
    def load(load_folder_path):
        ...
        new_model = JointTransRobertaModel(model_params, trans_model=None, is_load=True)
        new_model.model = tf.keras.models.load_model(os.path.join(load_folder_path,'joint_roberta_model.h5'))
        return new_model