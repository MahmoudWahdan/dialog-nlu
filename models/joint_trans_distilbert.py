...
from tensorflow.python.keras.layers import Input, Dense, Multiply, TimeDistributed, AveragePooling1D, Lambda
...
class JointTransDistilBertModel(NLUModel):
...
#        in_segment = Input(shape=(None,), name='input_type_ids', dtype=tf.int32)
    ...
    def load(load_folder_path):
        ...
        new_model = JointTransDistilBertModel(model_params, trans_model=None, is_load=True)
